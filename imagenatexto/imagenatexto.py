...
if os.name == 'nt':  # Verifica si el sistema es Windows
    ...
    # En Linux/Mac no se necesita configurar la ruta, se espera que esté en el PATH
    pass
...
if bg_image is not None:
    ...
    try:
        ...
        st.error("Tesseract no se encontró. Por favor, asegúrate de tener Tesseract OCR instalado y configurado correctamente.")
